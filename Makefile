...
ACLOCAL = ${SHELL} /home/p/perrier5/L3/Projet/elf_linker-1.0/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /home/p/perrier5/L3/Projet/elf_linker-1.0/build-aux/missing automake-1.15
AWK = gawk
CC = gcc
